...
export const FORMAT_DEFINITIONS: FormatDefinition[] = [
  ...
  {
    id: 'sunday_church_hole_games',
    name: 'Sunday Church Hole Games',
    shortLabel: 'HoleGames',
    gameDescription:
      'Classic Sunday Church skins where every hole is worth one skin and ties carry over, but each hole can use its own gameplay format to decide the winning score.',
    formatCategory: 'skins',
    defaultTeamSize: 4,
    supportedTeamSizes: [2, 3, 4],
    configOptions: [],
  ...
  },
  {
    ...
    shortLabel: 'Simon',
    gameDescription:
      'Classic Sunday Church skins with organizer-entered instructions for every hole. After a team scores a hole, the app shows the instruction for the next hole.',
    formatCategory: 'skins',
    defaultTeamSize: 4,
    supportedTeamSizes: [2, 3, 4],
    configOptions: [],
